...
- Trains multiple ML models using Scikit-Learn pipelines  
- Evaluates model performance  
- Generates price recommendations for given property attributes  
...
✔ Multiple regression models (Linear Regression, Random Forest, Gradient Boosting, etc.)  
